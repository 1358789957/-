...
#define LOW_PRECISION`),t}function gm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Yc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Kc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===fn&&(t="SHADOWMAP_TYPE_VSM"),t}function vm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wi:case Ri:t="ENVMAP_TYPE_CUBE";break;case $s:t="ENVMAP_TYPE_CUBE_UV";break}return t}function xm(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ri:t="ENVMAP_MODE_REFRACTION";break}return t}function Mm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Zc:t="ENVMAP_BLENDING_MULTIPLY";break;case Sh:t="ENVMAP_BLENDING_MIX";break;case yh:t="ENVMAP_BLENDING_ADD";break}return t}function Sm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function ym(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=gm(e),l=vm(e),h=xm(e),d=Mm(e),f=Sm(e),m=lm(e),_=hm(r),g=s.createProgram();let p,u,T=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(ji).join(`
`)),o=Ro(o),o=_c(o,e),o=gc(o,e),a=Ro(a),a=_c(a,e),a=gc(a,e),o=vc(o),a=vc(a),e.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+u);const E=T+p+o,x=T+u+a,P=fc(s,s.VERTEX_SHADER,E),w=fc(s,s.FRAGMENT_SHADER,x);s.attachShader(g,P),s.attachShader(g,w),e.index0AttributeName!==void 0?s.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function A(R){if(i.debug.checkShaderErrors){const O=s.getProgramInfoLog(g).trim(),F=s.getShaderInfoLog(P).trim(),V=s.getShaderInfoLog(w).trim();let X=!0,W=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,g,P,w);else{const j=mc(s,P,"vertex"),G=mc(s,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
...
${Oc}`),i.userData.shader=s},i.customProgramCacheKey=()=>"gel-carve-v2",i.needsUpdate=!0}const Do=1,Ul=2,Zs=3,Us=16;function B_(i,t,e,n,s,r,o,a,c){const l=i-n,h=t-s,d=e-r,f=l*o+h*a+d*c,m=l-o*f,_=h-a*f,g=d-c*f;return m*m+_*_+g*g}function z_(i,t,e,n){if(n.type===Do)return B_(i,t,e,n.ox,n.oy,n.oz,n.dx,n.dy,n.dz)<n.radius*n.radius;if(n.type===Ul){const s=i-n.ox,r=t-n.oy,o=e-n.oz;return s*s+r*r+o*o<n.radius*n.radius}return n.type===Zs?i*n.dx+t*n.dy+e*n.dz>n.offset:!1}class H_{constructor(){this.ops=[],this.flags=null,this.uniforms={uCarveCount:{value:0},uCarvePos:{value:Array.from({length:Us},()=>new Yt)},uCarveDir:{value:Array.from({length:Us},()=>new Yt)}}}push(t){this.ops.length>=Us&&this.ops.shift(),this.ops.push(t),this.syncUniforms()}undo(){this.ops.pop(),this.syncUniforms()}clear(){this.ops.length=0,this.syncUniforms()}contains(t,e,n){for(let s=0;s<this.ops.length;s++)if(z_(t,e,n,this.ops[s]))return!0;return!1}reorient(t,e,n,s,r){if(!this.ops.length)return;const o=this._p0||(this._p0=new Float32Array(3)),a=this._p1||(this._p1=new Float32Array(3)),c=this._d0||(this._d0=new Float32Array(3)),l=this._d1||(this._d1=new Float32Array(3));for(let h=0;h<this.ops.length;h++){const d=this.ops[h];if(t.unmapByOrient(d.ox,d.oy,d.oz,e,n,o),t.mapByOrient(o[0],o[1],o[2],s,r,a),t.unrotateByOrient(d.dx,d.dy,d.dz,e,c),t.rotateByOrient(c[0],c[1],c[2],s,l),d.type===Zs){const f=Math.hypot(d.dx,d.dy,d.dz)||1;t.unmapByOrient(d.dx/f*d.offset,d.dy/f*d.offset,d.dz/f*d.offset,e,n,o),t.mapByOrient(o[0],o[1],o[2],s,r,a);const m=Math.hypot(l[0],l[1],l[2])||1;d.offset=(l[0]*a[0]+l[1]*a[1]+l[2]*a[2])/m}d.ox=a[0],d.oy=a[1],d.oz=a[2],d.dx=l[0],d.dy=l[1],d.dz=l[2]}this.syncUniforms()}applyToSoft(t){const e=this.flags&&this.flags.length===t.count?this.flags:new Uint8Array(t.count);this.flags=e,e.fill(0);const n=t.rest;for(let s=0;s<t.count;s++){const r=s*3;this.contains(n[r],n[r+1],n[r+2])&&(e[s]=1)}return t.applyCarvedFlags(e),t.carvedCount()}syncUniforms(){const{uCarveCount:t,uCarvePos:e,uCarveDir:n}=this.uniforms;t.value=this.ops.length;for(let s=0;s<Us;s++){const r=e.value[s],o=n.value[s],a=this.ops[s];if(!a){r.set(0,0,0,0),o.set(0,1,0,0);continue}r.set(a.ox,a.oy,a.oz,a.type===Zs?a.offset:a.radius||0),o.set(a.dx,a.dy,a.dz,a.type)}}}function Nl(i,t,e){const n=i.x,s=i.z,r=Math.hypot(n,s);if(i.yNorm<.12||i.yNorm>.88)return{type:Do,ox:n,oy:0,oz:s,dx:0,dy:1,dz:0,radius:e};const a=r>1e-5?1/r:1;return{type:Do,ox:0,oy:i.y,oz:0,dx:t?n*a:1,dy:0,dz:t?s*a:0,radius:e}}function G_(i,t){return{type:Ul,ox:i.x,oy:i.y,oz:i.z,dx:0,dy:1,dz:0,radius:t}}function Fl(i,t,e){const n=i.x,s=i.z,r=Math.hypot(n,s)||1,o=n/r,a=s/r,c=e*(1.05-t/e);return{type:Zs,ox:0,oy:0,oz:0,dx:o,dy:0,dz:a,radius:0,offset:c}}const Fe=document.querySelector("#c"),V_=document.querySelector("#stats"),Lo=document.querySelector("#softness"),k_=document.querySelector("#softnessOut"),Bc=document.querySelector("#damping"),W_=document.querySelector("#dampingOut"),zc=document.querySelector("#gravity"),X_=document.querySelector("#gravityOut"),Io=document.querySelector("#pinBottom"),Uo=document.querySelector("#gelColor"),q_=document.querySelector("#gelColorOut"),Y_=document.querySelector("#shapeOut"),Hc=document.querySelector("#hint"),Ol=document.querySelector("#modeSim"),Bl=document.querySelector("#modeEdit"),K_=document.querySelector("#editPanel"),sa=document.querySelector("#toolSize"),Z_=document.querySelector("#toolSizeOut"),j_=document.querySelector("#quickReset"),zl=document.querySelector("#quickFix"),ra=document.querySelector("#axisX"),oa=document.querySelector("#axisY"),aa=document.querySelector("#axisZ"),Or=document.querySelector("#axisZero"),ca=document.querySelector("#hud"),No=document.querySelector("#hudToggle"),$_=ca.querySelector(".hud-bar"),Hl=window.matchMedia("(max-width: 920px), (max-height: 720px)");function la(){return Hl.matches||window.matchMedia("(pointer: coarse)").matches}function nr(i){ca.classList.toggle("collapsed",i),No.textContent=i?"设置":"收起",No.setAttribute("aria-expanded",i?"false":"true")}function Gl(i){i.preventDefault(),i.stopPropagation(),typeof i.stopImmediatePropagation=="function"&&i.stopImmediatePropagation(),nr(!ca.classList.contains("collapsed"))}nr(la());No.addEventListener("pointerdown",Gl);$_.addEventListener("pointerdown",i=>{i.target.closest("#hudToggle")||i.target.closest("input,button,label")||Gl(i)});Hl.addEventListener("change",()=>{la()&&nr(!0)});const xn=new e_({canvas:Fe,antialias:!0,alpha:!1,powerPreference:"high-performance"});xn.setPixelRatio(Math.min(window.devicePixelRatio,2));xn.setSize(window.innerWidth,window.innerHeight);xn.toneMapping=jc;xn.toneMappingExposure=1.05;xn.shadowMap.enabled=!0;xn.shadowMap.type=Kc;const Be=new Al;Be.background=new Ct(724500);Be.fog=new Jo(724500,8,18);const rn=new Ce(38,window.innerWidth/window.innerHeight,.08,40);rn.position.set(1.55,1.35,2.15);const Ze=new l_(rn,Fe);Ze.enableDamping=!0;Ze.dampingFactor=.08;Ze.enablePan=!1;Ze.target.set(0,.78,0);Ze.minDistance=1.1;Ze.maxDistance=6;Ze.maxPolarAngle=Math.PI*.49;const J_=new wo(xn);Be.environment=J_.fromScene(new y_,.04).texture;const Q_=new n_(12179455,1709070,.55);Be.add(Q_);const je=new Cl(16774374,1.35);je.position.set(2.4,4.2,1.6);je.castShadow=!0;je.shadow.mapSize.set(1024,1024);je.shadow.camera.near=.5;je.shadow.camera.far=12;je.shadow.camera.left=-2.5;je.shadow.camera.right=2.5;je.shadow.camera.top=2.5;je.shadow.camera.bottom=-2.5;je.shadow.bias=-4e-4;Be.add(je);const Vl=new Cl(8308991,.35);Vl.position.set(-2.2,1.4,-1.8);Be.add(Vl);const ha=new Zt(new Qo(4.5,72),new es({color:1316896,metalness:.35,roughness:.42,envMapIntensity:.55}));ha.rotation.x=-Math.PI/2;ha.receiveShadow=!0;Be.add(ha);const ua=new Zt(new tr(.62,.68,.06,64),new es({color:2765116,metalness:.55,roughness:.28}));ua.position.y=.03;ua.receiveShadow=!0;Be.add(ua);const it=new D_({radius:.36,height:1.42,radialSegs:8,heightSegs:11,rings:3,softness:.55,damping:.18,gravity:-7.2});let Qn=Ll({radialSegs:48,heightSegs:40,rimSegs:4,caps:"rims"});na(Qn,it);const da=I_(),Li=new Zt(Qn,da);Li.castShadow=!0;Li.receiveShadow=!0;Be.add(Li);const Oe=new H_;O_(da,Oe,it);const Zn=new Zt(new tr(1,1,2.4,28,1,!0),new Ni({color:8049919,transparent:!0,opacity:.22,depthWrite:!1,side:Ue})),bi=new Zt(new er(1,28,20),new Ni({color:16762222,transparent:!0,opacity:.28,depthWrite:!1})),Dn=new Zt(new as(1.6,1.7),new Ni({color:16747130,transparent:!0,opacity:.22,depthWrite:!1,side:Ue}));Zn.visible=!1;bi.visible=!1;Dn.visible=!1;Be.add(Zn,bi,Dn);let Xe=!1,ti="hole";const Un=new Zt(new er(1,32,24),new wl({color:15924223,roughness:.18,transmission:.35,thickness:.4,transparent:!0,opacity:.55,metalness:0}));Un.visible=!1;Un.castShadow=!0;Be.add(Un);const Ii=new o_,ns=new At,Fo=new pn,Oo=new L,Cn=new L,js=new L,Br=new L,Gc=new L,Ji=new L,Qi=new L,Ns=new L,Ki=new L;let ei=!1,Pe=!0,Fs=0,Vc=0,Os=0,kc=performance.now();function fa(i){const t=i.touches?i.touches[0]:i;if(!t)return;const e=Fe.getBoundingClientRect();ns.x=(t.clientX-e.left)/e.width*2-1,ns.y=-((t.clientY-e.top)/e.height)*2+1}function tg(i){const t=Qn.getAttribute("restPos"),e=i.face;let n=i.barycoord;if(e&&!n){const o=Qn.attributes.position;Ji.fromBufferAttribute(o,e.a),Qi.fromBufferAttribute(o,e.b),Ns.fromBufferAttribute(o,e.c),n=new L,Ne.getBarycoord(i.point,Ji,Qi,Ns,n)}if(e&&n&&t)return Ji.fromBufferAttribute(t,e.a),Qi.fromBufferAttribute(t,e.b),Ns.fromBufferAttribute(t,e.c),Ki.set(0,0,0).addScaledVector(Ji,n.x).addScaledVector(Qi,n.y).addScaledVector(Ns,n.z),{x:Ki.x,y:Ki.y,z:Ki.z,yNorm:(Ki.y-it.floorY)/it.height};const r=it.closestParticle(i.point.x,i.point.y,i.point.z,!1)*3;return{x:it.rest[r],y:it.rest[r+1],z:it.rest[r+2],yNorm:(it.rest[r+1]-it.floorY)/it.height}}function kl(){const i=Ii.intersectObject(Li,!1);for(let a=0;a<i.length;a++){const c=i[a],l=tg(c);if(!Oe.contains(l.x,l.y,l.z))return{point:c.point,rest:l,hit:c}}const t=Ii.ray;let e=.12,n=null;const{pos:s,A:r,H:o}=it;for(const a of[it.outerRing(),0])for(let c=0;c<o;c++)for(let l=0;l<r;l++){const h=it.ringIndex(a,c,l);if(it.carved[h])continue;Br.set(s[h*3],s[h*3+1],s[h*3+2]);const d=t.distanceToPoint(Br);if(d<e){e=d,t.closestPointToPoint(Br,Gc),Oo.copy(Gc);const f=h*3;n={point:Oo,rest:{x:it.rest[f],y:it.rest[f+1],z:it.rest[f+2],yNorm:(it.rest[f+1]-it.floorY)/it.height}}}}return n}function Wl(){const i=Number(sa.value)/100;return ti==="hole"?.032+i*.12:ti==="carve"?.05+i*.16:.07+i*.26}function pa(){Zn.visible=!1,bi.visible=!1,Dn.visible=!1}function Xl(i){if(pa(),!Xe||!i)return;const t=Wl();if(ti==="hole"){const e=Nl(i,!0,t);Zn.visible=!0,Zn.position.set(e.ox,e.oy,e.oz),Zn.scale.set(t,1,t),Zn.quaternion.setFromUnitVectors(Ji.set(0,1,0),Qi.set(e.dx,e.dy,e.dz))}else if(ti==="carve")bi.visible=!0,bi.position.set(i.x,i.y,i.z),bi.scale.setScalar(t);else{const e=Fl(i,t,it.radius);Dn.visible=!0,Dn.position.set(e.dx*e.offset,.77,e.dz*e.offset),Dn.lookAt(Dn.position.x+e.dx,.77,Dn.position.z+e.dz)}}function eg(i){const t=Wl();let e=null;ti==="hole"?e=Nl(i,!0,t):ti==="carve"?e=G_(i,t):e=Fl(i,t,it.radius),Oe.push(e),Oe.applyToSoft(it),Pe=!0}function ql(i){if(i.isPrimary===!1||i.button!=null&&i.button!==0||i.touches&&i.touches.length>1)return;fa(i),Ii.setFromCamera(ns,rn);const t=kl();if(!t)return;if(i.preventDefault(),i.stopImmediatePropagation(),Xe){eg(t.rest),Xl(t.rest);return}const e=t.point;ei=!0,Pe=!0,Ze.enabled=!1,Fe.style.cursor="grabbing",Oo.copy(e),rn.getWorldDirection(js),Fo.setFromNormalAndCoplanarPoint(js,e);const n=it.closestParticle(e.x,e.y,e.z,!0);it.grabParticle(n,e.x,e.y,e.z),it.attachFinger(e.x,e.y,e.z,.11),Un.position.copy(e),Un.scale.setScalar(.11),Un.visible=!0}function Yl(i){ei&&(fa(i),Ii.setFromCamera(ns,rn),rn.getWorldDirection(js),Fo.normal.copy(js),Ii.ray.intersectPlane(Fo,Cn)&&(it.moveGrab(Cn.x,Cn.y,Cn.z),it.moveFinger(Cn.x,Cn.y,Cn.z),Un.position.copy(Cn)))}function ir(){ei&&(ei=!1,Ze.enabled=!0,it.releaseFinger(),Un.visible=!1,Fe.style.cursor="default")}Fe.addEventListener("pointerdown",ql,{capture:!0});window.addEventListener("pointermove",Yl);window.addEventListener("pointerup",ir);window.addEventListener("pointercancel",ir);Fe.addEventListener("pointermove",i=>{if(ei)return;fa(i),Ii.setFromCamera(ns,rn);const t=kl();Xe?(Fe.style.cursor=t?"crosshair":"default",Xl(t?t.rest:null)):(pa(),Fe.style.cursor=t?"grab":"default")});Fe.addEventListener("touchstart",i=>{i.touches.length===1&&ql(i)},{capture:!0,passive:!1});window.addEventListener("touchmove",Yl,{passive:!1});window.addEventListener("touchend",ir);window.addEventListener("touchcancel",ir);function ng(i){return i<=28?"硬胶":i<=70?"中等":"超软"}function ma(i){const t=Number(i)/100;Lo.value=String(i),k_.textContent=`${ng(i)} ${Math.round(i)}%`,it.setSoftness(t),document.querySelectorAll("[data-soft]").forEach(e=>{e.classList.toggle("active",Number(e.dataset.soft)===Number(i))})}Lo.addEventListener("input",()=>ma(Lo.value));Bc.addEventListener("input",()=>{const i=Number(Bc.value)/100;W_.textContent=`${Math.round(i*100)}%`,it.setDamping(i)});zc.addEventListener("input",()=>{const i=Number(zc.value)/10;X_.textContent=i.toFixed(1),it.setGravity(-i)});Io.addEventListener("change",()=>it.setPinBottom(Io.checked));function ig(i){return i==="sphere"?"none":i==="grip"?"bottom":"rims"}function sg(){const i=it.shape==="sphere"?it.floorY+it.sphereRadius():it.floorY+it.height*.52;Ze.target.set(0,i,0)}function rg(){const i=Ll({radialSegs:L_(it.shape),heightSegs:40,rimSegs:4,caps:ig(it.shape)});na(i,it),Li.geometry.dispose(),Li.geometry=i,Qn=i}function og(i){it.setShape(i)&&(Oe.clear(),it.clearCarved(),rg(),sg(),Y_.textContent=Dl[it.shape]||"圆柱",document.querySelectorAll("[data-shape]").forEach(t=>{t.classList.toggle("active",t.dataset.shape===it.shape)}),Pe=!0)}function zr(i){const t=$i(i);return Number.isInteger(t)?String(t):t.toFixed(1)}function _a(){ra.value=zr(it.orientDeg.x),oa.value=zr(it.orientDeg.y),aa.value=zr(it.orientDeg.z)}function Kl(i){Oe.ops.length&&(Oe.reorient(it,i.prevR,i.prevLift,i.nextR,i.nextLift),Oe.applyToSoft(it)),_a(),Pe=!0}function ag(i,t,e){Kl(it.setOrientation(i,t,e))}function Zl(){it.reset(),Pe=!0}document.querySelector("#reset").addEventListener("click",Zl);document.querySelector("#drop").addEventListener("click",()=>{Xe||(Io.checked=!1,it.setPinBottom(!1),it.drop(1.05),Pe=!0)});document.querySelectorAll("[data-shape]").forEach(i=>{i.addEventListener("click",()=>og(i.dataset.shape))});document.querySelector("#poke").addEventListener("click",()=>{if(Xe)return;const i=it.placeRest(1,0,.58,new Float32Array(3));it.mapByOrient(i[0],i[1],i[2],it.orientR,it.orientLift,i);const e=it.closestParticle(i[0],i[1],i[2],!0)*3;it.vel[e]+=3.4,it.vel[e+2]+=.35,it.sleeping=!1,Pe=!0});document.querySelectorAll("[data-soft]").forEach(i=>{i.addEventListener("click",()=>ma(i.dataset.soft))});ma(55);function ga(i){Xe=i,Ol.classList.toggle("active",!i),Bl.classList.toggle("active",i),zl.classList.toggle("active",i),K_.hidden=!i,i?(it.reset(),Pe=!0,Hc.textContent="胶已固定。可对着空心壁打洞或切削。XYZ 调方向，重置只回正姿态。",Fe.style.cursor="crosshair",la()&&nr(!1)):(pa(),Hc.textContent="空心软胶，可从开口看到内壁。拖拽揉捏壁面；XYZ 调方向，重置只回正姿态。",Fe.style.cursor="default",it.sleeping=!1,Pe=!0)}function jl(){const i=Number(sa.value);Z_.textContent=i<30?"小":i<65?"中":"大"}Ol.addEventListener("click",()=>ga(!1));Bl.addEventListener("click",()=>ga(!0));document.querySelector("#quickBar").addEventListener("pointerdown",i=>{i.stopPropagation()});j_.addEventListener("pointerdown",i=>{i.preventDefault(),i.stopPropagation(),Zl()});zl.addEventListener("pointerdown",i=>{i.preventDefault(),i.stopPropagation(),ga(!Xe)});function Wc(){ag(ra.value,oa.value,aa.value)}[ra,oa,aa].forEach(i=>{i.addEventListener("change",Wc),i.addEventListener("keydown",t=>{t.key==="Enter"&&(t.preventDefault(),Wc(),i.blur())})});let Bo=0,zo=0;function Bs(){window.clearTimeout(Bo),window.clearInterval(zo),Bo=0,zo=0}function Xc(i,t){Kl(it.nudgeOrientation(i,t))}document.querySelectorAll(".axis-step").forEach(i=>{const t=i.dataset.axis,e=Number(i.dataset.delta);i.addEventListener("pointerdown",n=>{n.preventDefault(),n.stopPropagation(),i.setPointerCapture(n.pointerId),Xc(t,e),Bs(),Bo=window.setTimeout(()=>{zo=window.setInterval(()=>Xc(t,e),70)},380)}),i.addEventListener("pointerup",Bs),i.addEventListener("pointercancel",Bs),i.addEventListener("lostpointercapture",Bs)});Or.addEventListener("pointerdown",i=>{i.preventDefault(),i.stopPropagation(),it.setOrientationZero(),_a(),Or.textContent="已设为零点",window.setTimeout(()=>{Or.textContent="设为零点"},900)});_a();sa.addEventListener("input",()=>{jl()});jl();document.querySelectorAll("[data-tool]").forEach(i=>{i.addEventListener("click",()=>{ti=i.dataset.tool,document.querySelectorAll("[data-tool]").forEach(t=>{t.classList.toggle("active",t===i)})})});document.querySelector("#undoCarve").addEventListener("click",()=>{Oe.undo(),Oe.applyToSoft(it),Pe=!0});document.querySelector("#clearCarve").addEventListener("click",()=>{Oe.clear(),it.clearCarved(),Pe=!0});function qc(i){const t=String(i||"").trim();return/^#[0-9a-fA-F]{6}$/.test(t)?t.toLowerCase():ia}function va(i){const t=qc(i);Uo.value=t,q_.textContent=t.toUpperCase(),Il(da,t),document.querySelectorAll("#swatches [data-color]").forEach(e=>{e.classList.toggle("active",qc(e.dataset.color)===t)})}Uo.addEventListener("input",()=>va(Uo.value));document.querySelectorAll("#swatches [data-color]").forEach(i=>{i.addEventListener("click",()=>va(i.dataset.color))});va(ia);window.addEventListener("resize",()=>{rn.aspect=window.innerWidth/window.innerHeight,rn.updateProjectionMatrix(),xn.setSize(window.innerWidth,window.innerHeight)});function $l(i){const t=Math.min(.033,(i-kc)/1e3);if(kc=i,Xe||it.step(t),(Pe||ei||!Xe&&!it.sleeping)&&(na(Qn,it,{normals:Fs%2===0||ei||Xe}),Qn.computeBoundingSphere(),Pe=Xe?!1:!it.sleeping),Ze.update(),xn.render(Be,rn),Fs+=1,Os+=t,Os>=.4){Vc=Math.round(Fs/Os),Fs=0,Os=0;const e=it.carvedCount();V_.textContent=`${Vc} FPS · ${it.count-e}/${it.count} 质点 · ${Oe.ops.length} 处雕刻`}requestAnimationFrame($l)}requestAnimationFrame($l);
